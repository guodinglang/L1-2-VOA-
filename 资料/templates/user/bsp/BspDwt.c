...
*********************************************************************************************************
*/
void BspDwt_DelayMS(uint32_t _ulDelayTime)
{
	BspDwt_DelayUS(1000*_ulDelayTime);
}

/*
*********************************************************************************************************
*	函 数 名: BspDwt_DelayUS
...
*             -------------------------------------------
*                测试                 实际执行
*             BspDwt_DelayUS(1)          1.2360us
*             BspDwt_DelayUS(2)          2.256us
*             BspDwt_DelayUS(3)          3.256us
*             BspDwt_DelayUS(4)          4.256us
*             BspDwt_DelayUS(5)          5.276us
*             BspDwt_DelayUS(6)          6.276us
*             BspDwt_DelayUS(7)          7.276us
*             BspDwt_DelayUS(8)          8.276us
*             BspDwt_DelayUS(9)          9.276us
*             BspDwt_DelayUS(10)         10.28us
...
*********************************************************************************************************
*/
void BspDwt_DelayUS(uint32_t _ulDelayTime)
{

...
#if /* ARMCC */ ((defined(__CC_ARM) && defined(__TARGET_FPU_VFP)) /* Clang */ || (defined(__CLANG_ARM) && defined(__VFP_FP__) && !defined(__SOFTFP__)) /* IAR */ || (defined(__ICCARM__) && defined(__ARMVFP__)) /* GNU */ || (defined(__GNUC__) && defined(__VFP_FP__) && !defined(__SOFTFP__)))
#define USE_FPU 1
#else
#define USE_FPU 0
#endif
...
void rt_hw_hard_fault_exception(struct exception_info *exception_info)
{
    ...
    { // Add By User
        extern void rt_hw_console_SetBlockMode(rt_uint8_t ucState);

        rt_hw_console_SetBlockMode(1);
    }
#endif

...
//***************************************************************************/
rxStructure   	urStruct[2];//,*tPort=0;//*pUART=&urStruct1;
rxStructure     *pUART=&urStruct[0],*pCAN1=&urStruct[1];//,*pUSB=&urStruct[2],*pDUT2=&urStruct[3];

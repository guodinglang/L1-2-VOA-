	...
	if (s > 0)
	{
		...
		if (s <= 3)
		{
			...
			case 1:
				...
				break;
			case 2:
				LCD_ShowASCII(0, 124, (u8 *)">", fc, bc, 24, 0);
				break;
			case 3:
				LCD_ShowASCII(0, 205, (u8 *)">", fc, bc, 24, 0);
				break;
			}
		}
		else if (s <= 9)
...
void SubSelectGUI(uint8_t s, uint8_t loc, char *es, uint16_t fc, uint16_t bc)
{
	...
	case 7:
	{
		...
		{
		case 0:
			LCD_ShowASCII(112, 145, (u8 *)es, fc, bc, 24, 0);
			break; // 192
		case 1:
			LCD_ShowASCII(160, 145, (u8 *)es, fc, bc, 24, 0);
			break; // 168
		case 2:
			LCD_ShowASCII(208, 145, (u8 *)es, fc, bc, 24, 0);
			break; // 1
		case 3:
			LCD_ShowASCII(258, 145, (u8 *)es, fc, bc, 24, 0);
			break; // 1
		}
...
void MainGUI(uint16_t fc, uint16_t bc)
{
	...
	//	if(setups.language)
	//	{
	//		LCD_ShowASCII(16,64,(u8 *)"VOA Device:",fc,bc,32,0);
	//		memset(str,0,25);
	//		itoa_32(Ivoa.cp,str);
	//		LCD_ShowASCII(208,64,(u8 *)str,fc,bc,32,0);
	//
	//		LCD_ShowASCII(16,120,(u8 *)"Wavelength:",fc,bc,32,0);
	//		memset(str,0,25);
	//		itoa_32(Ivoa.wl,str);
	//		LCD_ShowASCII(208,120,(u8 *)str,fc,bc,32,0);
	//
	//		LCD_ShowASCII(16,176,(u8 *)"Attenuation:",fc,bc,32,0);
	//		memset(str,0,25);
	//		ftoa(Ivoa.db,1,str);
	//		LCD_ShowASCII(220,176,(u8 *)str,fc,bc,32,0);
	//
	//	}
	//	else
	//	{
	//		LCD_ShowChinese(16,70,(u8 *)"当前器件",fc,bc,24,0);
	//		LCD_ShowASCII(112,64,(u8 *)":",fc,bc,32,0);
	//		memset(str,0,25);
	//		itoa_32(Ivoa.cp,str);
	//		LCD_ShowASCII(136,64,(u8 *)str,fc,bc,32,0);
	//
	//		LCD_ShowChinese(16,126,(u8 *)"器件波长",fc,bc,24,0);
	//		LCD_ShowASCII(112,120,(u8 *)":",fc,bc,32,0);
	//		memset(str,0,25);
	//		itoa_32(Ivoa.wl,str);
	//		LCD_ShowASCII(136,120,(u8 *)str,fc,bc,32,0);

	//		LCD_ShowChinese(16,182,(u8 *)"器件衰减",fc,bc,24,0);
	//		LCD_ShowASCII(112,176,(u8 *)":",fc,bc,32,0);
	//		memset(str,0,25);
	//		ftoa(Ivoa.db,2,str);
	//		LCD_ShowASCII(136,176,(u8 *)str,fc,bc,32,0);
	//
	//	}
}
/***************************************************************************
...
;** 修改原因：
;***************************************************************************/
void SimplenessVOA(uint16_t fc, uint16_t bc)
{
	//	char str[25]={0};
	//
	//	if(setups.language)
	...
	//		memset(str,0,25);
	//		itoa_32(Ivoa.cp,str);
	//		LCD_Fill(208,64,320,96,bc);
	//		LCD_ShowASCII(208,64,(u8 *)str,fc,bc,32,0);
	//
	//		memset(str,0,25);
	//		itoa_32(Ivoa.wl,str);
	//		LCD_Fill(208,120,320,152,bc);
	//		LCD_ShowASCII(208,120,(u8 *)str,fc,bc,32,0);
	//
	//		memset(str,0,25);
	//		ftoa_nr(Ivoa.db,1,str);
	//		LCD_Fill(220,176,320,208,bc);
	//		LCD_ShowASCII(220,176,(u8 *)str,fc,bc,32,0);
	//
	//	}
	//	else
	...
	//		memset(str,0,25);
	//		itoa_32(Ivoa.cp,str);
	//		LCD_Fill(136,64,320,96,bc);
	//		LCD_ShowASCII(136,64,(u8 *)str,fc,bc,32,0);
	//
	//		memset(str,0,25);
	//		itoa_32(Ivoa.wl,str);
	//		LCD_Fill(136,120,320,152,bc);
	//		LCD_ShowASCII(136,120,(u8 *)str,fc,bc,32,0);
	//
	//		memset(str,0,25);
	//		ftoa_nr(Ivoa.db,1,str);
	//		LCD_Fill(136,176,320,208,bc);
	//		LCD_ShowASCII(136,176,(u8 *)str,fc,bc,32,0);
	//	}
}

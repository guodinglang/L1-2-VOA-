...
void Set_IIC_SDA(void)
{
	...
	{
	case 0:
		gpio_bits_set(GPIOSDA, GPIO_EERAM_SDA);
		break;
	}
}
/***************************************************************************
...
void Clr_IIC_SDA(void)
{
	...
	{
	case 0:
		gpio_bits_reset(GPIOSDA, GPIO_EERAM_SDA);
		break;
	}
}
/***************************************************************************
...
void Clr_IIC_SCL(void)
{
	...
	{
	case 0:
		gpio_bits_reset(GPIOSCL, GPIO_EERAM_SCL);
		break;
	}
}
/***************************************************************************
...
void Set_IIC_SCL(void)
{
	...
	{
	case 0:
		gpio_bits_set(GPIOSCL, GPIO_EERAM_SCL);
		break;
	}
}
/***************************************************************************
...
uint8_t readSDA(void)
{
	...
	{
	case 0:
		ck = gpio_input_data_bit_read(GPIOSDA, GPIO_EERAM_SDA);
		break;
	}
	return ck;
}
